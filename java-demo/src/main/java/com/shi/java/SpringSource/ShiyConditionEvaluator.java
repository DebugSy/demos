 ...
 * @since 4.0
 */
class ShiyConditionEvaluator {

	private final ConditionContextImpl context;


	/**
	 * Create a new {@link ShiyConditionEvaluator} instance.
	 */
	public ShiyConditionEvaluator(BeanDefinitionRegistry registry, Environment environment, ResourceLoader resourceLoader) {
	...
	public boolean shouldSkip(AnnotatedTypeMetadata metadata, ConfigurationPhase phase) {
		...
		if (phase == null) {
			if (metadata instanceof AnnotationMetadata &&
					ShiyConfigurationClassUtils.isConfigurationCandidate((AnnotationMetadata) metadata)) {
