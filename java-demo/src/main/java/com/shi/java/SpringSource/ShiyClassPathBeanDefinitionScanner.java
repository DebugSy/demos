 ...
 */
public class ShiyClassPathBeanDefinitionScanner extends ShiyClassPathScanningCandidateComponentProvider {
	...
	/**
	 * Create a new {@code ShiyClassPathBeanDefinitionScanner} for the given bean factory.
	 * @param registry the {@code BeanFactory} to load bean definitions into, in the form
	 * of a {@code BeanDefinitionRegistry}
	 */
	public ShiyClassPathBeanDefinitionScanner(BeanDefinitionRegistry registry) {
		this(registry, true);
	}
	 ...
	 * @see #setEnvironment
	 */
	public ShiyClassPathBeanDefinitionScanner(BeanDefinitionRegistry registry, boolean useDefaultFilters) {
		this(registry, useDefaultFilters, getOrCreateEnvironment(registry));
	}

	/**
	 * Create a new {@code ShiyClassPathBeanDefinitionScanner} for the given bean factory and
	 ...
	 * @see #setResourceLoader
	 */
	public ShiyClassPathBeanDefinitionScanner(BeanDefinitionRegistry registry, boolean useDefaultFilters, Environment environment) {
	...
	public int scan(String... basePackages) {
		...
		if (this.includeAnnotationConfig) {
			ShiyAnnotationConfigUtils.registerAnnotationConfigProcessors(this.registry);
		}
		...
		for (String basePackage : basePackages) {
			...
			for (BeanDefinition candidate : candidates) {
				...
				if (candidate instanceof AnnotatedBeanDefinition) {
					ShiyAnnotationConfigUtils.processCommonDefinitionAnnotations((AnnotatedBeanDefinition) candidate);
				}
				if (checkCandidate(beanName, candidate)) {
					BeanDefinitionHolder definitionHolder = new BeanDefinitionHolder(candidate, beanName);
					definitionHolder = ShiyAnnotationConfigUtils.applyScopedProxyMode(scopeMetadata, definitionHolder, this.registry);
